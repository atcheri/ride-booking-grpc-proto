...
const file_trip_trip_proto_rawDesc = "" +
	"\n" +
	"\x0ftrip/trip.proto\"\x8e\x01\n" +
	"\x12PreviewTripRequest\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x121\n" +
	"\rstartLocation\x18\x02 \x01(\v2\v.CoordinateR\rstartLocation\x12-\n" +
	"\vendLocation\x18\x03 \x01(\v2\v.CoordinateR\vendLocation\"t\n" +
	"\x13PreviewTripResponse\x12\x16\n" +
	"\x06tripID\x18\x01 \x01(\tR\x06tripID\x12\x1c\n" +
	"\x05route\x18\x02 \x01(\v2\x06.RouteR\x05route\x12'\n" +
	"\trideFares\x18\x03 \x03(\v2\t.RideFareR\trideFares\"F\n" +
	"\n" +
	"Coordinate\x12\x1a\n" +
	"\blatitude\x18\x01 \x01(\x01R\blatitude\x12\x1c\n" +
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude\"9\n" +
	"\bGeometry\x12-\n" +
	...
	"\x06tripID\x18\x01 \x01(\tR\x06tripID\x12\x19\n" +
	"\x04trip\x18\x02 \x01(\v2\x05.TripR\x04trip\"\xb4\x01\n" +
	"\x04Trip\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12-\n" +
	"\fselectedFare\x18\x02 \x01(\v2\t.RideFareR\fselectedFare\x12\x1c\n" +
	"\x05route\x18\x03 \x01(\v2\x06.RouteR\x05route\x12\x16\n" +
	"\x06status\x18\x04 \x01(\tR\x06status\x12\x16\n" +
	"\x06userID\x18\x05 \x01(\tR\x06userID\x12\x1f\n" +
	"\x06driver\x18\x06 \x01(\v2\a.DriverR\x06driver\"p\n" +
	"\x06Driver\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12&\n" +
	"\x0eprofilePicture\x18\x03 \x01(\tR\x0eprofilePicture\x12\x1a\n" +
	"\bcarPlate\x18\x04 \x01(\tR\bcarPlate2~\n" +
	"\vTripService\x128\n" +
...
var file_trip_trip_proto_goTypes = []any{
	(*PreviewTripRequest)(nil),  // 0: PreviewTripRequest
	(*PreviewTripResponse)(nil), // 1: PreviewTripResponse
	(*Coordinate)(nil),          // 2: Coordinate
	(*Geometry)(nil),            // 3: Geometry
	(*Route)(nil),               // 4: Route
	(*RideFare)(nil),            // 5: RideFare
	(*CreateTripRequest)(nil),   // 6: CreateTripRequest
	(*CreateTripResponse)(nil),  // 7: CreateTripResponse
	(*Trip)(nil),                // 8: Trip
	(*Driver)(nil),              // 9: Driver
}
var file_trip_trip_proto_depIdxs = []int32{
	2,  // 0: PreviewTripRequest.startLocation:type_name -> Coordinate
	2,  // 1: PreviewTripRequest.endLocation:type_name -> Coordinate
	4,  // 2: PreviewTripResponse.route:type_name -> Route
	5,  // 3: PreviewTripResponse.rideFares:type_name -> RideFare
	2,  // 4: Geometry.coordinates:type_name -> Coordinate
	3,  // 5: Route.geometry:type_name -> Geometry
	8,  // 6: CreateTripResponse.trip:type_name -> Trip
	5,  // 7: Trip.selectedFare:type_name -> RideFare
	4,  // 8: Trip.route:type_name -> Route
	9,  // 9: Trip.driver:type_name -> Driver
	0,  // 10: TripService.PreviewTrip:input_type -> PreviewTripRequest
	6,  // 11: TripService.CreateTrip:input_type -> CreateTripRequest
	1,  // 12: TripService.PreviewTrip:output_type -> PreviewTripResponse
	7,  // 13: TripService.CreateTrip:output_type -> CreateTripResponse
